<template>
  <div>
    <div id="toolbar" class="row items-center">
      <q-btn flat dense icon="undo" @click="undo" class="q-ml-auto">
        <q-tooltip :offset="[8, 8]"> 撤销 </q-tooltip>
      </q-btn>
      <q-btn flat dense icon="redo" @click="redo" class="q-ml-xs">
      ...
      <q-btn flat dense icon="zoom_out" @click="zoomOut" class="q-ml-xs">
        <q-tooltip :offset="[8, 8]"> 缩小 (Ctrl + 滚轮向下) </q-tooltip>
      </q-btn>
      <q-separator vertical inset class="q-ml-xs" />
      <q-btn flat dense icon="center_focus_weak" @click="centerContent" class="q-ml-xs">
        <q-tooltip :offset="[8, 8]"> 居中 </q-tooltip>
      </q-btn>
      <q-btn flat dense icon="grid_4x4" @click="shGird" class="q-ml-xs">
      ...
      <q-btn flat dense icon="download" @click="downloadData" class="q-ml-xs">
        <q-tooltip :offset="[8, 8]"> 导出 json </q-tooltip>
      </q-btn>
      <q-separator vertical inset class="q-ml-xs" />
      <q-btn flat dense color="primary" icon="directions_run" @click="runWorkFlow" class="q-ml-xs">
